...
TEST_CASE("5*5"){ //50
    ...
    //player 1
        ...
        CHECK_THROWS(board.move(2,{4,0},Board::MoveDIR::Up));//out of board
        ...
        board.move(2,{4,1},Board::MoveDIR::Down); //foot
        ...
        CHECK_THROWS(board.move(2,{3,0},Board::MoveDIR::Down));//wrong player
        CHECK_THROWS(board.move(2,{4,4},Board::MoveDIR::Right));//out
        CHECK_THROWS(board.move(1,{0,4},Board::MoveDIR::Right));//out
        CHECK_THROWS(board.move(1,{0,2},Board::MoveDIR::Right));//cant move

        board.move(2,{4,3},Board::MoveDIR::Down);
        board.move(1,{0,3},Board::MoveDIR::Up);
        board.move(2,{3,3},Board::MoveDIR::Right);
        board.move(1,{3,0},Board::MoveDIR::Right);
        ...
        CHECK_THROWS(board.move(1,{0,1},Board::MoveDIR::Right));//cant move
        ...
        board.move(2,{4,2},Board::MoveDIR::Down);
        ...
        CHECK_THROWS(board.move(1,{2,2},Board::MoveDIR::Right));//wrong player
        CHECK_THROWS(board.move(2,{1,3},Board::MoveDIR::Left));//wrong player
        CHECK_THROWS(board.move(2,{3,1},Board::MoveDIR::Left));//wrong player
        ...
        board.move(2,{4,2},Board::MoveDIR::Down);
        board.move(1,{3,1},Board::MoveDIR::Left);
        board.move(2,{3,3},Board::MoveDIR::Down);

        CHECK_THROWS(board.move(2,{0,1},Board::MoveDIR::Up));//no soldier
        CHECK_THROWS(board.move(2,{3,0},Board::MoveDIR::Down));//wrong player
        CHECK_THROWS(board.move(2,{4,1},Board::MoveDIR::Up));//out
        CHECK_THROWS(board.move(1,{3,0},Board::MoveDIR::Left));//out
        CHECK_THROWS(board.move(2,{3,2},Board::MoveDIR::Down));//cant move
        CHECK_THROWS(board.move(2,{2,2},Board::MoveDIR::Up));//cant move
        CHECK_THROWS(board.move(2,{2,2},Board::MoveDIR::Right));//cant move
        CHECK_THROWS(board.move(1,{4,1},Board::MoveDIR::Right));//wrong player
        CHECK_THROWS(board.move(1,{3,2},Board::MoveDIR::Right));//wrong player
